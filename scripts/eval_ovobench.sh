...
echo "======================================"
echo "Running with FOSS_K_MAX=${FOSS_K_MAX}, FOSS_MAX_NEW_BASIS=${FOSS_MAX_NEW_BASIS}"
echo "======================================"
...
if [ "$EVAL_ONLY" == "False" ]; then
    for IDX in "${!GPULIST[@]}"; do
        ...
        python3 -W ignore ./eval/modeling_$TASK.py \
            --model-path "$CKPT" \
            --video-dir ./OVOBench/data/chunked_videos \
            --gt-file ./OVOBench/ovo_bench_real_time.json \
